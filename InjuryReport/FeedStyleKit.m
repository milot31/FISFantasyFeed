...
+ (void)initialize
{
    ...
    _gradientColor2 = [UIColor colorWithRed: 0.88 green: 0.862 blue: 0.862 alpha: 0.536];
    _gradientColor3 = [UIColor colorWithRed: 0.939 green: 0.932 blue: 0.932 alpha: 0.248];
